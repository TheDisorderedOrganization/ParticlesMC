...
The external-field Hamiltonian and its contribution to trial-move energy
changes are not yet implemented; the current code establishes only mass storage
and the orientation geometry on which that later term will depend.
